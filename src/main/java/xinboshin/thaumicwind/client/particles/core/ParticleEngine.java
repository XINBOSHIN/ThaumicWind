...
public class ParticleEngine {
	...
	public static final ResourceLocation SPRITE_SHEET = new ResourceLocation(Magistics.ID, "textures/misc/particles.png");
	public static final ResourceLocation SPRITE_SHEET_ALT = new ResourceLocation(Magistics.ID, "textures/misc/particles2.png");
	...
	private static void crashParticle(Exception err, Particle effect) {
		...
		category.addCrashSection("ParticleType", getParticleTypeCallable());
